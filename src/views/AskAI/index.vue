...
const goToChatAI = () => {
  ...
  router.push({
    path: '/chat-ai',
    query: { q: question.value }
  })
}

// 带问题跳转到AI对话页面
const goToChatAIWithQuestion = (q) => {
  router.push({
    path: '/chat-ai',
    query: { q }
  })
...
<template>
  <div class="ask-ai-page">
    <div class="container">
      ...
      <div class="ask-ai-container">
        ...
        <section class="ai-hero-section">
          <div class="hero-content">
            <h2>一站式房产工具与AI分析平台</h2>
            <p>为全球房产投资者和专业人士提供智能工具与数据分析服务</p>
          </div>
        </section>
        ...
        <div class="question-input-area">
          <div class="question-input-box">
            <input 
              ...
              @keyup.enter="goToChatAI"
            >
            <button @click="goToChatAI" :disabled="isLoading">
        ...
        <div class="suggested-questions-container">
          ...
          <div class="suggested-questions-list">
            <div 
              ...
              @click="goToChatAIWithQuestion(q)"
            >
      ...
      <!-- 房产工具分类展示 -->
      <div class="property-tools-container">
        <h2 class="section-title">专业房产工具</h2>
        
        <div class="tools-filter">
          <button class="filter-btn active">全部工具</button>
          <button class="filter-btn">投资分析</button>
          <button class="filter-btn">市场研究</button>
          <button class="filter-btn">法律文档</button>
          <button class="filter-btn">贷款融资</button>
          <button class="filter-btn">税务规划</button>
        </div>
        
        <div class="tools-grid">
          <!-- 投资分析工具 -->
          <div class="tool-card investment-tool">
            <div class="tool-icon">
              <i class="fas fa-chart-pie"></i>
            </div>
            <div class="tool-content">
              <h3 class="tool-title">投资回报计算器</h3>
              <p class="tool-description">计算房产投资的现金流、回报率和投资回收期，帮助您做出明智的投资决策</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
          ...
          <div class="tool-card investment-tool">
            ...
            <div class="tool-content">
              <h3 class="tool-title">租金收益分析</h3>
              <p class="tool-description">分析不同地区和房型的租金收益率，找出最具投资价值的房产类型和地区</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <!-- 市场研究工具 -->
          <div class="tool-card research-tool">
            <div class="tool-icon">
              <i class="fas fa-map-marked-alt"></i>
            </div>
            <div class="tool-content">
              <h3 class="tool-title">全球房价热力图</h3>
              <p class="tool-description">直观展示全球各地房价水平、增长率和投资热度，帮助您发现潜在投资机会</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <div class="tool-card research-tool">
            ...
            <div class="tool-content">
              <h3 class="tool-title">区域价值评估</h3>
              <p class="tool-description">评估特定区域的发展潜力、基础设施、生活便利性和投资价值</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <!-- 法律文档工具 -->
          <div class="tool-card legal-tool">
            <div class="tool-icon">
              <i class="fas fa-file-contract"></i>
            </div>
            <div class="tool-content">
              <h3 class="tool-title">合同文档生成器</h3>
              <p class="tool-description">生成标准的房产买卖、租赁合同和协议，支持多国法律体系和多语言</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <div class="tool-card legal-tool">
            ...
            <div class="tool-content">
              <h3 class="tool-title">政策法规查询</h3>
              <p class="tool-description">查询全球主要国家和地区的房产政策、税收法规和外国人购房限制</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <!-- 贷款融资工具 -->
          <div class="tool-card finance-tool">
            <div class="tool-icon">
              <i class="fas fa-percentage"></i>
            </div>
            <div class="tool-content">
              <h3 class="tool-title">房贷计算器</h3>
              <p class="tool-description">计算月供、总利息和贷款成本，比较不同贷款方案和还款方式</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <div class="tool-card finance-tool">
            ...
            <div class="tool-content">
              <h3 class="tool-title">全球贷款利率比较</h3>
              <p class="tool-description">比较不同国家和地区的房贷利率、条件和申请要求</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <!-- 税务规划工具 -->
          <div class="tool-card tax-tool">
            <div class="tool-icon">
              <i class="fas fa-file-invoice-dollar"></i>
            </div>
            <div class="tool-content">
              <h3 class="tool-title">房产税务计算器</h3>
              <p class="tool-description">计算房产交易、持有和出售过程中的各项税费，优化税务规划</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
          ...
          <div class="tool-card tax-tool">
            ...
            <div class="tool-content">
              <h3 class="tool-title">跨国税务规划</h3>
              <p class="tool-description">为跨国房产投资者提供税务筹划建议，避免双重征税</p>
              <div class="tool-actions">
                <button class="tool-btn">立即使用</button>
                <button class="tool-btn-outline">
                  <i class="far fa-bookmark"></i>
        ...
        <div class="tools-more">
          <button class="tools-more-btn">
            <i class="fas fa-th-large"></i> 查看更多工具
          </button>
        </div>
      </div>
      ...
      <div v-if="isLoggedIn && userStore.historyQuestions.length > 0" class="history-questions-container">
        ...
        <div class="history-questions-list">
          <div 
            ...
            @click="goToChatAIWithQuestion(item.question)"
          >
...
.investment-tool .tool-icon {
  color: #1890ff;
  background-color: #e6f7ff;
}

.research-tool .tool-icon {
  color: #52c41a;
  background-color: #f6ffed;
}

.legal-tool .tool-icon {
  color: #722ed1;
  background-color: #f9f0ff;
}

.finance-tool .tool-icon {
  color: #fa8c16;
...
.investment-tool .tool-btn {
  background-color: #1890ff;
}

.investment-tool .tool-btn:hover {
  background-color: #40a9ff;
}

.research-tool .tool-btn {
  background-color: #52c41a;
}

.research-tool .tool-btn:hover {
...
.legal-tool .tool-btn:hover {
  background-color: #9254de;
}

.finance-tool .tool-btn {
  background-color: #fa8c16;
}

.finance-tool .tool-btn:hover {
